data "aws_iam_policy_document" "aws-assume-role-policy-eks-techlead-academy" {
  version = "2012-10-17"
  statement {
...
data "aws_iam_policy_document" "aws-assume-role-policy-ec2-techlead-academy" {
  version = "2012-10-17"
  statement {
    actions = ["sts:AssumeRole"]
    effect  = "Allow"
...
data "aws_iam_policy_document" "aws-cluster-auto-scaler-policy-document-techlead-academy" {
  version = "2012-10-17"
  statement {
    effect = "Allow"
    actions = [
...
data "aws_iam_policy_document" "aws-ingress-policy-document-techlead-academy" {
  version = "2012-10-17"
  statement {
    effect = "Allow"
    actions = [
...
data "aws_iam_policy_document" "aws-external-dns-policy-document-techlead-academy" {
  version = "2012-10-17"
  statement {
    effect = "Allow"
    actions = [
...
resource "aws_iam_policy" "aws-external-dns-policy-poc-eks-academy" {
  ...
  policy = data.aws_iam_policy_document.aws-external-dns-policy-document-techlead-academy.json
}
...
resource "aws_iam_policy" "aws-ingress-policy-poc-eks-academy" {
  ...
  policy = data.aws_iam_policy_document.aws-ingress-policy-document-techlead-academy.json
}
...
resource "aws_iam_policy" "aws-cluster-auto-scaler-policy-poc-eks-academy" {
  ...
  policy = data.aws_iam_policy_document.aws-cluster-auto-scaler-policy-document-techlead-academy.json
}
...
resource "aws_iam_role" "aws-iam-eks-master-poc-eks-academy" {
  ...
  assume_role_policy    = data.aws_iam_policy_document.aws-assume-role-policy-eks-techlead-academy.json
}

resource "aws_iam_role" "aws-iam-eks-nodes-poc-eks-academy" {
  name                  = "eks-role-nodes-${var.cluster-name}"
  force_detach_policies = true
  assume_role_policy    = data.aws_iam_policy_document.aws-assume-role-policy-ec2-techlead-academy.json
}
